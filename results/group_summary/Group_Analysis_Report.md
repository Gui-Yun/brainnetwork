...
|:------------|:----------------|:----------------|:-------------------|:---------------------|:-------------------|:------------------|:---------------------|:----------------|:----------------|:-----------------|:-----------------|:----------------|:----------------|:-------------------|:----------------------|:----------------------|:-------------------------|:-----------------------|:----------------------|:-------------------------|:-----------------------|:----------------------|:-------------------------------|:-----------------------------|:----------------------------|:-----------------------------|:---------------------------|:--------------------------|
| Convergent  | 3.6441 ± 0.0946 | 0.5667 ± 0.012  | 0.2074 ± 0.0104    | 0.3902 ± 0.0115      | 0.0727 ± 0.0092    | 0.3175 ± 0.006    | 1.6652 ± 0.1043      | 0.6058 ± 0.0188 | 0.0763 ± 0.0056 | 40.7756 ± 6.0798 | 17.0692 ± 2.5878 | 0.1166 ± 0.0151 | 0.0481 ± 0.0056 | 12.662 ± 1.0949    | 19.8142 ± 1.3431      | 20.75 ± 1.3463        | 0.278 ± 0.018            | 0.422 ± 0.027          | -0.1439 ± 0.0154      | 0.3699 ± 0.0261          | 0.2033 ± 0.0146        | 0.1666 ± 0.0151       | 0.7393 ± 0.0155                | 0.4151 ± 0.072               | 0.3242 ± 0.0635             | 0.6348 ± 0.0141              | 0.2585 ± 0.0495            | 0.3763 ± 0.0461           |
| Divergent   | 3.7198 ± 0.0614 | 0.5528 ± 0.0184 | 0.2051 ± 0.0114    | 0.3894 ± 0.0136      | 0.0728 ± 0.0099    | 0.3166 ± 0.008    | 1.724 ± 0.1179       | 0.6052 ± 0.0172 | 0.0866 ± 0.0046 | 43.1043 ± 6.8232 | 17.2985 ± 2.4186 | 0.1184 ± 0.0116 | 0.049 ± 0.0041  | 11.1515 ± 0.9164   | 18.6441 ± 1.3651      | 20.25 ± 1.3595        | 0.285 ± 0.0174           | 0.4114 ± 0.0261        | -0.1263 ± 0.0138      | 0.3761 ± 0.0354          | 0.1957 ± 0.0145        | 0.1805 ± 0.0247       | 0.7325 ± 0.0164                | 0.4057 ± 0.0618              | 0.3267 ± 0.0584             | 0.6252 ± 0.0119              | 0.2401 ± 0.0376            | 0.3851 ± 0.0388           |
...
| :--- | :--- | :--- | :--- | :--- |
| **Entropy** | Friedman chi2=3.250, p=1.9691e-01 | p=0.2500 (ns) | p=0.0547 (ns) | p=0.6406 (ns) |
| **Mean_RSM_Sim** | Friedman chi2=7.000, p=3.0197e-02 | p=0.3828 (ns) | p=0.0156 (*) | p=0.0234 (*) |
...
| **Gini_Mean** | Friedman chi2=4.750, p=9.3014e-02 | p=0.7422 (ns) | p=0.0391 (*) | p=0.0781 (ns) |
| **PR_Mean** | Friedman chi2=1.750, p=4.1686e-01 | p=0.4609 (ns) | p=0.1953 (ns) | p=0.1953 (ns) |
| **PR_Norm_Mean** | Friedman chi2=1.750, p=4.1686e-01 | p=0.7422 (ns) | p=0.1484 (ns) | p=0.3125 (ns) |
| **Effective_Dim_PR** | Friedman chi2=2.250, p=3.2465e-01 | p=0.1094 (ns) | p=0.5469 (ns) | p=0.3828 (ns) |
| **Effective_Dim_eRank** | Friedman chi2=1.750, p=4.1686e-01 | p=0.1953 (ns) | p=0.5469 (ns) | p=0.5469 (ns) |
| **Effective_Dim_90Var** | Friedman chi2=1.727, p=4.2163e-01 | p=0.4688 (ns) | p=1.0000 (ns) | p=0.5000 (ns) |
